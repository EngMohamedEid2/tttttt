    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.style == "basic") {
        _push(ssrRenderComponent(_component_nuxt_link, mergeProps({
          to: (_a = "NavigationLinks" in _ctx ? _ctx.NavigationLinks : unref(NavigationLinks)) == null ? void 0 : _a.compare,
          class: "header-icon"
        }, _attrs), {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<small class="badge-number badge-light"${_scopeId}>2</small>`);
              ...
              return [
                createVNode("small", { class: "badge-number badge-light" }, "2"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Header/Elements/Compare.vue");
