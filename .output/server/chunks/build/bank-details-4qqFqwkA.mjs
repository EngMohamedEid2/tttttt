...
import _sfc_main$3 from './index-CULAZpkM.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    var breadcrumbs = { page: "Bank Details", links: [{ name: "Bank Details" }] };
    return (_ctx, _push, _parent, _attrs) => {
      const _component_WidgetsBreadcrumb = _sfc_main$1;
      const _component_AccountWrapper = _sfc_main$2;
      const _component_AccountBankDetails = _sfc_main$3;
      ...
      _push(ssrRenderComponent(_component_AccountWrapper, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_AccountBankDetails, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_AccountBankDetails)
            ];
          }
        }),
        _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/account/bank-details.vue");
