function convertInputData({ data, removeKeys }) {
  ...
  removeKeys == null ? void 0 : removeKeys.forEach((key) => key in objToSend && delete objToSend[key]);
  return objToSend;
}
