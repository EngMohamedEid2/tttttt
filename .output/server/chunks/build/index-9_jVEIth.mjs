...
import _sfc_main$2 from './ForgotPassword-DROtYh3M.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    var breadcrumbs = { page: "Forgot Password", links: [{ name: "Forgot Password" }] };
    return (_ctx, _push, _parent, _attrs) => {
      const _component_WidgetsBreadcrumb = _sfc_main$1;
      const _component_AuthForgotPassword = _sfc_main$2;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      _push(ssrRenderComponent(_component_WidgetsBreadcrumb, { breadcrumbs: unref(breadcrumbs) }, null, _parent));
      _push(ssrRenderComponent(_component_AuthForgotPassword, null, null, _parent));
      _push(`</div>`);
    };
  }
};
