...
import _sfc_main$2 from './index-BxaGIHyk.mjs';
...
import { e as useDataStore, s as storeToRefs } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    watchEffect(() => {
      ...
      bannerImageUrl.value = (_a = themeOptions == null ? void 0 : themeOptions.collection) == null ? void 0 : _a.collection_banner_image_url;
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ShopCollectionWidgetsSidebar = _sfc_main$1;
      const _component_ShopCollectionWidgetsBanner = _sfc_main$2;
      const _component_ShopCollectionWidgetsCollectionProduct = _sfc_main$3;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "section-b-space shop-section" }, _attrs))}><div class="container-fluid-lg"><div class="row"><div class="col-custome-3"><div class="${ssrRenderClass([{ show: unref(offCanvasMenu) }, "left-box wow fadeInUp"])}">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Shop/Collection/Banner/index.vue");
