import _sfc_main$1 from './index-SHQXt7jW.mjs';
import { useSSRContext } from 'vue';
import { ssrRenderComponent } from 'vue/server-renderer';
import { _ as _export_sfc } from './server.mjs';
import './Berlin-D5IfTCrN.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_ThemesBerlin = _sfc_main$1;
  _push(ssrRenderComponent(_component_ThemesBerlin, _attrs, null, _parent));
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/theme/berlin/index.vue");
