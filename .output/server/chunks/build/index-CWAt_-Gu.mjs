...
import _sfc_main$1 from './index-BH6f2NPb.mjs';
import _sfc_main$2 from './index-CWXewHSq.mjs';
import _sfc_main$3 from './index-BvojuXMb.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-D35ckuRb.mjs';
import { d as __nuxt_component_1 } from './server.mjs';
import _sfc_main$4 from './index-C2K7bQml.mjs';
import _sfc_main$5 from './index-Bmsaf34f.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ShopSellerWidgetsContectDetails = _sfc_main$1;
      const _component_ShopSellerWidgetsStoreName = _sfc_main$2;
      const _component_ShopSellerWidgetsStoreRating = _sfc_main$3;
      const _component_nuxt_link = __nuxt_component_0$1;
      const _component_Icon = __nuxt_component_1;
      const _component_ShopSellerWidgetsStoreLogo = _sfc_main$4;
      const _component_WidgetsNoData = _sfc_main$5;
      ...
      if (__props.skeletonLoader) {
        ...
        ssrRenderList(__props.stores, (store) => {
          ...
          _push(ssrRenderComponent(_component_nuxt_link, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(ssrRenderComponent(_component_Icon, { name: "ri-arrow-right-line" }, null, _parent2, _scopeId));
              } else {
                return [
                  createTextVNode(toDisplayString("Visit Store") + " "),
                  createVNode(_component_Icon, { name: "ri-arrow-right-line" })
                ];
              }
            }),
            _: 2
          ...
          _push(ssrRenderComponent(_component_nuxt_link, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(_component_ShopSellerWidgetsStoreLogo, { store }, null, _parent2, _scopeId));
              } else {
                return [
                  createVNode(_component_ShopSellerWidgetsStoreLogo, { store }, null, 8, ["store"])
                ];
              }
            }),
            _: 2
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Shop/Seller/Store/Classic/index.vue");
