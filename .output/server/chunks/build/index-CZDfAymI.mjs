...
import _sfc_main$2 from './Register-Co9bke4_.mjs';
...
import './RegisterForm-BX2kCth-.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    var breadcrumbs = { page: "Register", links: [{ name: "Register" }] };
    return (_ctx, _push, _parent, _attrs) => {
      const _component_WidgetsBreadcrumb = _sfc_main$1;
      const _component_AuthRegister = _sfc_main$2;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      _push(ssrRenderComponent(_component_WidgetsBreadcrumb, { breadcrumbs: unref(breadcrumbs) }, null, _parent));
      _push(ssrRenderComponent(_component_AuthRegister, null, null, _parent));
      _push(`</div>`);
    };
  }
};
