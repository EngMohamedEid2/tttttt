import _sfc_main$1 from './index-DJ_0JLnF.mjs';
import { useSSRContext } from 'vue';
import { ssrRenderComponent } from 'vue/server-renderer';
import { _ as _export_sfc } from './server.mjs';
import './Paris-g35CgsyG.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_ThemesParis = _sfc_main$1;
  _push(ssrRenderComponent(_component_ThemesParis, _attrs, null, _parent));
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/theme/paris/index.vue");
