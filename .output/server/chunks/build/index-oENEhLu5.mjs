import _sfc_main$1 from './Image-Pbz6eKoP.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c;
      const _component_ShopProductDetailsSilderImage = _sfc_main$1;
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><section class="pt-0"><div class="container-fluid-lg">`);
      _push(ssrRenderComponent(_component_ShopProductDetailsSilderImage, { Data: __props.Data }, null, _parent));
      _push(`</div></section><section class="product-section"><div class="container-fluid-lg"><div class="row"><div class="col-xxl-9 col-xl-8 col-lg-7"><div class="row g-4"><div class="col-12"><div class="right-box-contain full-width-right-box">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Shop/ProductDetails/Silder/index.vue");
