import _sfc_main$1 from './index-CdrChLkR.mjs';
import { useSSRContext } from 'vue';
import { ssrRenderComponent } from 'vue/server-renderer';
import { _ as _export_sfc } from './server.mjs';
import './Madrid-DqCmloTD.mjs';
...
import './index-BfofmLq3.mjs';
import './index-D3nzSjU_.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_ThemesMadrid = _sfc_main$1;
  _push(ssrRenderComponent(_component_ThemesMadrid, _attrs, null, _parent));
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/theme/madrid/index.vue");
