import _sfc_main$1 from './Image-BXBp7EvI.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c;
      const _component_ShopProductDetailsStickyImage = _sfc_main$1;
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "product-section" }, _attrs))}><div class="container-fluid-lg"><div class="row"><div class="col-xxl-9 col-xl-8 col-lg-7"><div class="row g-4"><div class="col-xl-6"><div class="product-left-box"><div class="row g-sm-4 g-2">`);
      _push(ssrRenderComponent(_component_ShopProductDetailsStickyImage, { Data: __props.Data }, null, _parent));
      _push(`</div></div></div><div class="col-xl-6"><div class="right-box-contain p-sticky">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Shop/ProductDetails/Sticky/index.vue");
