...
import _sfc_main$3 from './index-qySUpzdd.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    var breadcrumbs = { page: "Notifications", links: [{ name: "Notifications" }] };
    return (_ctx, _push, _parent, _attrs) => {
      const _component_WidgetsBreadcrumb = _sfc_main$1;
      const _component_AccountWrapper = _sfc_main$2;
      const _component_AccountNotification = _sfc_main$3;
      ...
      _push(ssrRenderComponent(_component_AccountWrapper, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_AccountNotification, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_AccountNotification)
            ];
          }
        }),
        _: 1
