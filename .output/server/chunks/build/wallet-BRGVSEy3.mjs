...
import _sfc_main$3 from './index-C3cVB596.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_AccountWrapper, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_AccountWallet, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_AccountWallet)
            ];
          }
        }),
        _: 1
