...
var content = {
	home_banner: {
		status: true,
		main_banner: {
			image_url: "/images/data/themes/osaka/1.jpg",
			redirect_link: {
		...
		sub_banner_1: {
			image_url: "/images/data/themes/osaka/2.jpg",
			redirect_link: {
				link: "vegetables-fruits",
				link_type: "collection",
	...
	categories_icon_list: {
		...
		image_url: "/images/data/themes/osaka/3.png",
		category_ids: [
			1,
			2,
			3,
	...
	coupons: {
		image_url: "/images/data/themes/osaka/4.jpg",
		redirect_link: {
			link: "vegetables-fruits",
			link_type: "collection"
		},
	...
	offer_banner: {
		image_url: "/images/data/themes/osaka/5.jpg",
		redirect_link: {
			link: "vegetables-fruits",
			link_type: "collection"
		},
		...
		bundles: [
			{
				...
				image_url: "/images/data/themes/osaka/6.jpg",
				redirect_link: {
