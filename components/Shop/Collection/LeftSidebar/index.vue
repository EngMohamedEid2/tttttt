    ...
    <div class="container-fluid-lg">
      <div class="row">
        ...
        <div class="col-custome-9">
          <ShopCollectionWidgetsCollectionProduct
            @changeProductPage="changePages"
            :filter="filter"
          />
        </div>
      </div>
...
let bannerImageUrl =
  ThemeOptions?.value?.options?.collection?.collection_banner_image_url;
